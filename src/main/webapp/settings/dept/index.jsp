...
<div style="width: 95%">
    ...
    <div style="height: 50px; position: relative;top: 0px; left:30px;">
        ...
        <div style="position: relative;top: -88px; left: 285px;">
            <nav>
                <ul class="pagination">
                    <li class="disabled" id="first"><a href="${pageContext.request.contextPath}/dept/limitSelect/${sessionScope.Page.pageSize}/1">首页</a></li>
                    <li class="disabled" id="befo"><a href="${pageContext.request.contextPath}/dept/limitSelect/${sessionScope.Page.pageSize}/${sessionScope.Page.pageno-1}">上一页</a></li>
                    <li class="disabled" id="next"><a href="${pageContext.request.contextPath}/dept/limitSelect/${sessionScope.Page.pageSize}/${sessionScope.Page.pageno+1}" >下一页</a></li>
                    <li class="disabled" id="last"><a href="${pageContext.request.contextPath}/dept/limitSelect/${sessionScope.Page.pageSize}/${sessionScope.Page.pages}">末页</a></li>
                </ul>
            </nav>
        </div>
    </div>
